...
USER = {
    ...
    'link': [
        {'href': '/ovirt-engine/api/users/USER_ID/roles', 'rel': 'roles'}
    ],
}
...
def test_validate_token_success(
    mock_follow_link, mock_search, mock_get_profiles, mock_get_token_info
):
    ...
    mock_follow_link.assert_called_once_with(
        obj=USER,
        rel='roles',
        ca_file=ANY,
        engine_host=ANY,
